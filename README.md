...
- **Universal File Attachments**: Attach and preview PDFs, Office documents, zip files, audio, and video directly within notes. Retryable 8 MiB multipart uploads, streamed downloads, streaming ZIP export/restore, chunked desktop offline staging, and disk-backed WebDAV backups safely support attachments up to 1 GiB across Cloudflare and Docker deployments.
